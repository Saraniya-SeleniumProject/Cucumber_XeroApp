package com.training.cucumber.steps1TrialVer;
...
public class StepDefs_AddAnOrganisationXeroApp {
	...
	public void user_logs_into_the_application_with_correct_username_and_pwd() throws Throwable
	{
	 ...
	 @When ("^Add one more organisation$")
	 
	 public void add_one_more_organisation() throws Throwable
	 {
		   ...
		   //Click on Start TRIAL Button
			WebElement StartTrial_Button= driver.findElement(By.xpath("//button[@class='xui-button xui-actions--primary xui-actions--button-spacing xui-button-main xui-button-medium']"));
			StartTrial_Button.click();
