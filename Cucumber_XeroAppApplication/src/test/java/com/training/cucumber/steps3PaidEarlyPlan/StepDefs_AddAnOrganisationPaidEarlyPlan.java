package com.training.cucumber.steps3PaidEarlyPlan;
...
public class StepDefs_AddAnOrganisationPaidEarlyPlan {
	...
	public void user_logs_into_the_application_with_correct_username_and_pwd() throws Throwable
	{
	 ...
	 @Then ("^Choose StarterPlan on payment options page$")
	 public void choose_StarterPlan_on_payment_options_page() throws Throwable
	 {
		
		 //Select Early Starter Plan Tab
		     WebElement EarlyFrame = driver.findElement(By.id("Early"));
			driver.switchTo().frame(EarlyFrame);
		    driver.findElement(By.xpath("//section[@id='Early']//div[@class='xui-styledcheckboxradio--radio']")).click();
