package com.training.cucumber.steps5PaidEstdPlan;
...
public class StepDefs_AddAnOrganisationPaidEstdPlan {
WebDriver driver;
	...
	public void user_logs_into_the_application_with_correct_username_and_pwd() throws Throwable
	{
	 ...
	 @Then ("^Choose Established Plan on payment options page$")
	 public void choose_established_plan_on_payment_options_page() throws Throwable
	 {
		
		 //Select Early Starter Plan Tab
		     WebElement EstablishedFrame = driver.findElement(By.id("Established"));
			driver.switchTo().frame(EstablishedFrame);
		    driver.findElement(By.xpath("//section[@id='Established']//div[@class='xui-styledcheckboxradio--radio']")).click();
